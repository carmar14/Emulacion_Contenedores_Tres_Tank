...
void loop() {
  ...
  x2 = analogRead(33) * 3.3 / 4095.0; // GPIO33 (ADC1)
  ...
  */
  ...
  // Enviar el estado x3 a través del DAC
  dacWrite(salidaPin, x3 * 255 / 3.3); // Convertir x3 a un valor de 0-255 para el DAC

  // Enviar el estado y acciones de control al centro de control
  char buffer[100];
  int buffer_length = sprintf(buffer, "x3:%f,u1:%f,u2:%f", x3, u1, u2);
